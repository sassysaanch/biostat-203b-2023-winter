...
final_fit %>% 
  collect_metrics()
```
Report: It appears that the accuracy for each of these models is pretty similar. 
Xgboost: ROC = 0.717, Accuracy = 0.748
Random forest: ROC = 0.724, Accuracy = 0.742
Logistic Regression: ROC = 0.70, Accuracy = 0.7449