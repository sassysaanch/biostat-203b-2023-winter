...
2. Using read.csv and fread only gave me the time that elapsed while using this function. While using read_csv allowed me to also understand which variables exist in the dataset with their respective class types, number of rows and columns.
...
#this makes sense because admissions_tble had 53150 distinct ids and after the semi join I expected there to 
